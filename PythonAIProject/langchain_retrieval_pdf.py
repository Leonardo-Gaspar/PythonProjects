...
carregadores = [
    PyPDFLoader("GTB_standard_Nov23.pdf", encoding = "utf-8"),
    PyPDFLoader("GTB_gold_Nov23.pdf", encoding = "utf-8"),
    PyPDFLoader("GTB_platinum_Nov23.pdf", encoding = "utf-8")
    ]

documentos = []
for carregador in carregadores:
    documentos.extend(carregadores.load())
