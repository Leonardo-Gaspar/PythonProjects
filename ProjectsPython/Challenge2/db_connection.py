    ...
    if connection:
        try:
            ...
            for i in range(1, 11):
                ...
                """, [usuario_id, f'000.000.000-{i:02d}', f'Nome{i}', f'Sobrenome{i}', '1990-01-01', 'M' if i % 2 == 0 else 'F'])
                ...
                cursor.execute("""
                    ...
                    VALUES (:1, :2, :3, :4)
                """, [contato_usuario_id, usuario_id, f'email{i}@example.com', f'(11)90000-000{i%10}'])
                ...
                """, [endereco_usuario_id, usuario_id, f'00000-00{i%10}', f'Cidade{i}', 'SP', f'Rua{i}', f'Bairro{i}'])
